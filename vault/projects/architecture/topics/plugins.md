...
![Plugins](https://jmchilton.github.io/galaxy-architecture/_images/core_plugins_overview.mindmap.plantuml.svg)

## Datatypes

![Datatype Files](https://jmchilton.github.io/galaxy-architecture/_images/core_files_datatypes.mindmap.plantuml.svg)

Developer docs on adding new datatypes can be found at https://docs.galaxyproject.org/en/latest/dev/data_types.html.

## Tools

![ToolBox Classes](https://jmchilton.github.io/galaxy-architecture/_images/core_toolbox_classes.plantuml.svg)
...
![Tool Classes](https://jmchilton.github.io/galaxy-architecture/_images/core_tool_classes.plantuml.svg)

![Running Tools](https://jmchilton.github.io/galaxy-architecture/_images/core_tool_sequence.plantuml.svg)
...
![Job Runners](https://jmchilton.github.io/galaxy-architecture/_images/core_runner_classes.plantuml.svg)

![Handling Jobs](https://jmchilton.github.io/galaxy-architecture/_images/core_jobs_sequence.plantuml.svg)

![Data Managers](https://jmchilton.github.io/galaxy-architecture/_images/data_managers.svg)
...
![Object Store](https://jmchilton.github.io/galaxy-architecture/_images/objectstore.plantuml.svg)

These implementation are found below `lib/galaxy/objectstore/`.

![File Source Plugins](https://jmchilton.github.io/galaxy-architecture/_images/core_file_sources.plantuml.svg)
...
![Workflow Modules](https://jmchilton.github.io/galaxy-architecture/_images/core_workflow_modules.plantuml.svg)
...
![Workflow Modules](https://jmchilton.github.io/galaxy-architecture/_images/core_files_plugin_example.mindmap.plantuml.svg)
