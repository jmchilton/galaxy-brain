...
These alternatives were considered and rejected in favor of a `PickValueModule` workflow module. See [PROBLEM_AND_GOAL.md](projects/cwl/older_plans/pickValue/PROBLEM_AND_GOAL.md) for the chosen approach.
