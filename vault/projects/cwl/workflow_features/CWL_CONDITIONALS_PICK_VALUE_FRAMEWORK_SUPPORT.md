...
- `condifional_scatter_on_nonscattered_true_nojs` (should pass with Phase 0 alone — all conditions true)
...
- **Phase 0 first:** `condifional_scatter_on_nonscattered_true_nojs` should go green with just the int[] defaults fix (all conditions true, no pickValue filtering needed).
