...
| - | - | - |
| `abstract-b1-artifact-and-oracle.md` | leads with the system | 2,329 |
| `abstract-b3-deliverable.md` | leads with what a user gets | 2,269 |

Before authors and affiliations, B1 leaves roughly 870 characters and B3 roughly 930 characters
